...
export default function success() {
  return (
    <div className='bg-indigo-200 px-10 pt-20 pb-40 flex justify-center items-center'>
      <div className='bg-violet-300 border-2 border-black px-32 py-10 flex flex-col justify-center items-center'>
        <IoBagCheckSharp className='w-16 h-16 text-green-700' />
        <h1 className='text-4xl font-extrabold text-center wordSpacingTight tracking-tight'>
          Thank You For Your Order!
        </h1>
        <p className='text-xl font-bold text-center wordSpacingTight tracking-tight'>
