  ...
  return (
    <>
      {heroBanner && (
        <section>
          {discounted && (
            <p className='w-full bg-yellow-300 text-lg font-extrabold px-4 text-center border-yellow-400 border-b-4'>
          ...
          <div className='bg-white flex items-center border-black border-b-2 flex-col sm:flex-row'>
            ...
            <div className='relative w-full h-96 sm:h-96 sm:w-1/2 py-12 px-1 xs5:px-4 xs3:px-8 lg:p-16 bg-fuchsia-300 border-black border-b-2 sm:border-r-2 sm:border-b-0'>
              {/* Hero Text */}
              <h2 className='text-lg xs4:text-3xl xs3:text-5xl font-bold wordSpacingTight tracking-tight uppercase mb-2'>
                {heroText}
              </h2>
              ...
              {/* Price */}
              <p className='text-4xl xs3:text-7xl font-black wordSpacingPrice tracking-tight text-emerald-700 mb-4'>
                &euro; {discountPrice}{' '}
              ...
              <Link
                ...
                className='bg-black text-white text-2xl wordSpacingTight tracking-tight font-medium px-11 py-2 rounded-md'
                style={{
                  fontSize: '1.5rem',
                }}
              >
